...
private:
    ...
    int mFrameWidth, mFrameHeight;  //capture picture size. get from device! It is buffer size, not content size.
    int mFrameWidthOut, mFrameHeightOut;    //mpi_vi output picture size. In common, frameWidthOut == frameWidth, but in anti-shake mode, frameWidthOut < frameWidth. It is buffer size, not content size.
