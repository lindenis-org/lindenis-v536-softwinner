# Makefile for eyesee-mpp/framework/media/camera
CUR_PATH := .
PACKAGE_TOP := ../..
...
INCLUDE_DIRS := \
    ...
    $(EYESEE_MPP_INCLUDE)/middleware/media/LIBRARY/libMODSoft/include \
...
ifneq (,$(findstring $(strip $(TARGET_PRODUCT)),v316_sdv v316_sdvlpddr)) #ifeq ("$(strip $(TARGET_PRODUCT))", "v316_sdv")
    LOCAL_CFLAGS += -DPRODUCT_V5SDV
    LOCAL_CXXFLAGS += -DPRODUCT_V5SDV
endif
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-framework-media-camera done
	@echo ===================================
