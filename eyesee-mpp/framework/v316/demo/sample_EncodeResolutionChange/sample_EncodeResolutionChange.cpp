...
status_t SampleEncodeResolutionChangeContext::loadConfig()
{
    ...
    if(ConfigFilePath.empty())
    {
        ...
        mConfigPara.mDispWidth = 640;
        mConfigPara.mDispHeight = 360;
        ...
        mConfigPara.mIDRFrameInterval = mConfigPara.mFrameRate;
        mConfigPara.mbVideoEncodingPIntra = false;
        ...
        mConfigPara.mEncodeFolderPath = "/home/sample_EncodeResolutionChange_Files";
