...
typedef std::map<HWND_EX_, View*> KeyMap;
...
#define SDV_KEY_RIGHT   SCANCODE_SUNXIRETURN
...
#define SDV_KEY_RETURN  SCANCODE_SUNXIRIGHT 
#else
#define SDV_KEY_LEFT    SCANCODE_SUNXILEFT
...
inline View* KeyMapSearch(KeyMap view_map, HWND_EX_ handle)
{
