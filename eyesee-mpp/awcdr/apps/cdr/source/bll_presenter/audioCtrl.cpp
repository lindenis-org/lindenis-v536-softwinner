    ...
    , volume_(0)
{
   ...
   wav_file_list_.emplace(AUTOPHOTO_SOUND, CON_2STRING(AUDIO_FILE_PATH, "shutter.wav"));
   wav_file_list_.emplace(SHUTDOWN_SOUND, CON_2STRING(AUDIO_FILE_PATH, "shutdown.wav"));
   wav_file_list_.emplace(TIMECOUNT_SOUND, CON_2STRING(AUDIO_FILE_PATH, "autophoto.wav"));
   wav_file_list_.emplace(STARTUP_SOUND, CON_2STRING(AUDIO_FILE_PATH, "startup.wav"));
#if 0
