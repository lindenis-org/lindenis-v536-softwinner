...
#include "../../../tutk/wrapper/AVIOCTRLDEFs.h"
...
#define AW_MAX_ENCODE_CHN_NUM   4
...
#define AW_NET_MAC_LEN          20
#define AW_NET_IP_ADDR_LEN      16
...
typedef struct AWMenuconfig_ {
    int resoultion_value;
    int loop_record_time;
    int recod_type;
    int video_exp_value;
    int parking_value;
    int Gsensor_senstvity_value;
    int screen_onoff_value;
    int language_value;
    int record_sound_value;
    int record_sound_level_vaule;
    int moton_detect_value;
    int light_value;

    int resoultion_value_count;
    int loop_record_time_count;
    int recod_type_count;
    int video_exp_value_count;
    int parking_value_count;
    int Gsensor_senstvity_value_count;
    int screen_onoff_value_count;
    int language_value_count;
    int record_sound_value_count;
    int record_sound_level_vaule_count;
    int moton_detect_value_count;
    int light_value_count;
} AWMenucofig;


typedef struct AWDeviceInfoex_ {
    unsigned int device_id;
    char device_name[DEVICE_NAME_SIZE];
    char software[VERSION_TEXT_SIZE];
    char hardware[VERSION_TEXT_SIZE];
    AWMenucofig menu_config_;
} AWDeviceInfo_ex;
...
typedef struct AWEnCodeConfig_ {
    ...
    int vi_width;
    int vi_height;
    int encode_format;  // 0: h264,  1: h265
    int encode_type;    // 0:CBR, 1:VBR
    int quality;        // leve:0~2
    int bps[AW_MAX_ENCODE_CHN_NUM];
    int fps[AW_MAX_ENCODE_CHN_NUM];
    int gop[AW_MAX_ENCODE_CHN_NUM];
    AWEncodeSize encode_size[AW_MAX_ENCODE_CHN_NUM];
}AWEnCodeConfig;
    ...
    public:
        ...
        class MediaControl {
            public:
                 ...
                 *  - 失败 -1
                 */
                virtual int GetVideoChannelCnt(int &count) = 0;
                 ...
                 */
                 #if 0
                virtual int GetOnvifSimpleProfile(int ch, OnvifSimpleProfile &profile) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int GetOnvifVideoEncodingConfigOptions(int ch, OnvifVideoEncodingConfigOptions &options) = 0;
                 ...
                 *  - ...
                 * @param ch 流通道号
                 *  - 0,  对于tutk, 因为只有一路流，使用默认通道0
                 *  - >=0，对于onvif，因为有多路流， 必须指定待设置的流对应的recorder类型。
                 * @param width 视频宽度
                 * @param height 视频高度
                 ...
                 */
                 #endif
                virtual int SetVideoQuality(ControllerType ctrl_type, int ch, int width, int height,
                 ...
                 *  - 失败 -1
                 */
                virtual int SetVencFrameRate(ControllerType ctrl_type, int ch, int framerate) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int SetVencBitRate(ControllerType ctrl_type, int ch, int bitrate) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int SetVencGop(ControllerType ctrl_type, int ch, int gop) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int SetVencType(ControllerType ctrl_type, int ch, int type) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int SetVencFormat(ControllerType ctrl_type, int ch, int format) = 0;
                 ...
                 *  - 失败 -1
                 */
                virtual int GetStreamUrl(int ch, char *url, int size) = 0;

                virtual int GetMediaConfig(AWEnCodeConfig &media_cfg) = 0;

                virtual int SaveMediaConfig(void) = 0;

                virtual int DefaultMediaConfig(void) = 0;

                virtual int SetVencSize(ControllerType ctrl_type, int ch, int width, int height) = 0;

                virtual int SetVencQuality(ControllerType ctrl_type, int ch, int quality) = 0;

                virtual int SetVideoResoulation(ControllerType ctrl_type, int ch, int index) = 0;

                virtual int SetRecordTime(ControllerType ctrl_type, int ch, int index) = 0;

                virtual int SetRecordDelayTime(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetRecordAudioOnOff(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetRecordEisOnOff(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetSlowRecord(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetPicResolution(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetTimeTakePic(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetAutoTimeTakePic(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetContinuousPictureMode(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetExposureValue(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetWhiteBalance(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetLightFreq(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetPreviewFlip(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetTimeWaterMark(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int FormatStorage(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetCamerAutoScreenSaver(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetCameraTimeShutDown(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetDeviceLanguage(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetDeviceDateTime(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetDeviceReset(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetDeviceLedSwitch(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetDeviceDistortioncalibrationSwitch(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int GetDeviceConfig(ControllerType ctrl_type,int ch,int index,SMsgAVIoctrSDVDevConfigResp &resp) = 0;
                virtual int RemoteClientDisconnect(void) = 0;
                virtual int RemotePreviewChange(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int RemoteSaveMenuconfig(ControllerType ctrl_type,int ch,int index) = 0;                
                virtual int SetParkingMonitor(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetParkingMonitorLevel(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetSystemAudioLevel(ControllerType ctrl_type,int ch,int index) = 0;
                virtual int SetMotionDetect(ControllerType ctrl_type,int ch,int index) = 0;                
                virtual int SetRecordType(ControllerType ctrl_type, int ch, int index) = 0;
                virtual int SetDeviceDate(ControllerType ctrl_type, int ch, std::string str) = 0;
                virtual int SetDeviceTime(ControllerType ctrl_type, int ch, std::string str) = 0;
                virtual int SetWifiSsid(ControllerType ctrl_type, int ch, std::string str) = 0;
                virtual int SetWifiPassword(ControllerType ctrl_type, int ch, std::string str)= 0;
               // RemotePreviewChange
                 ...
                 *  - 失败 -1
                 */
                virtual int SnapShot(ControllerType ctrl_type, int ch) = 0;
        };
        ...
        class OverlayControl
        {
            public:
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int SetTimeOsd(int stream_id, const AWTimeOsd &time_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int GetTimeOsd(int stream_id, AWTimeOsd &time_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int SetChannelOsd(int vi_chn, int stream_id, const AWChannelOsd &chn_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int GetChannelOsd(int vi_chn, int stream_id, AWChannelOsd &chn_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int SetDeviceOsd(int stream_id, const AWDeviceOsd &device_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int GetDeviceOsd(int stream_id, AWDeviceOsd &device_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int SetCoverOsd(int vi_chn, int cover_id, const AWCoverOsd &cover_osd) = 0;
                 ...
                 *  - OSD模块未初始化 -2
                 */
                virtual int GetCoverOsd(int vi_chn, int cover_id, AWCoverOsd &cover_osd) = 0;

                virtual int SaveOverlayConfig(void) = 0;

                virtual int DefaultOverlayConfig(void) = 0;
        };
        ...
        class ImageControl
        {
            public:
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageColour(int vi_ch, const AWImageColour &image_colour) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageColour(int vi_ch, AWImageColour &image_colour) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageWhiteBalance(int vi_ch, int wb_type) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageWhiteBalance(int vi_ch, int &wb_type) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageExposure(int vi_ch, int exp_type, int exp_time) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageExposure(int vi_ch, int &exp_type, int &exp_time) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageWideDynamic(int vi_ch, int wd_leve) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageWideDynamic(int vi_ch, int &wd_leve) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageDayNightMode(int vi_ch, const AWDayNightMode &mode) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageDayNightMode(int vi_ch, AWDayNightMode &mode) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageDenoise(int vi_ch, int dn_leve) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageDenoise(int vi_ch, int &dn_leve) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageFlickerFreq(int vi_ch, int freq) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageFlickerFreq(int vi_ch, int &freq) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageFlip(int vi_ch, int enable_flip) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageFlip(int vi_ch, int &enable_flip) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetImageMirror(int vi_ch, int enable_mirror) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetImageMirror(int vi_ch, int &enable_mirror) = 0;
        ...
        class EventControl
        {
            public:
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetAlarmMdConfig(int vi_chn, const AWAlarmMd &alarm_md) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetAlarmMdConfig(int vi_chn, AWAlarmMd &alarm_md) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int SetAlarmCoverConfig(int vi_chn, const AWAlarmCover &alarm_cover) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetAlarmCoverConfig(int vi_chn, AWAlarmCover &alarm_cover) = 0;
                 ...
                 *  - 操作失败 -1
                 */
                virtual int GetEventStatus(int chn, int event_type, int &status) = 0;
        ...
        class RecordControl
        {
            public:
                ...
                /**
                 * @brief  v5 sdv remote ctrl record and take photo
                 * @param chn default 0
                 * @param vi_ch 视频输入通道
                 * @return
                 *  - 成功 0
                ...
                virtual int RemoteSwitchRecord() = 0;
                virtual int RemoteTakePhoto() = 0;
                virtual int RemoteSwitchSlowRecord() = 0;
                
                virtual int RemoteSwitchRecord(int value) = 0;
                virtual int GetCurretRecordTime() = 0;
        ...
        class DeviceControl
        {
            public:
                ...
                virtual void GetDeviceInfo_ex(AWDeviceInfo_ex &dev_info) = 0;
                ...
                virtual int GetSystemVersion(char *buf) = 0;
        };
