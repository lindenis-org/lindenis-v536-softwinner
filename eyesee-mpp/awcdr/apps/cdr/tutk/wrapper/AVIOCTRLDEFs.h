...
typedef enum {
    ...
    IOTYPE_USER_IPCAM_SETSOFTAP_REQ = 0x0336,
    IOTYPE_USER_IPCAM_SETSOFTAP_RESP = 0x0337,
    IOTYPE_USER_IPCAM_GETSOFTAP_REQ = 0x0338,
    IOTYPE_USER_IPCAM_GETSOFTAP_RESP = 0x0339,
...
/***********************allWinner IPC support Cmd *************************/
    IOTYPE_USER_IPCAM_SET_IPADDR_REQ = 0x600,
    IOTYPE_USER_IPCAM_SET_IPADDR_RESP = 0x601,
    IOTYPE_USER_IPCAM_GET_IPADDR_REQ = 0x602,
    IOTYPE_USER_IPCAM_GET_IPADDR_RESP = 0x603,

    IOTYPE_USER_IPCAM_GET_DEVICE_CONFIG_REQ = 0x604,
    IOTYPE_USER_IPCAM_GET_DEVICE_CONFIG_RESP = 0x605,

    //param setting
    IOTYPE_USER_IPCAM_SET_DECODETYPE_REQ = 0x607,
    IOTYPE_USER_IPCAM_SET_DECODETYPE_RESP = 0x608,

    IOTYPE_USER_IPCAM_SET_STREAMTYPE_REQ = 0x609,
    IOTYPE_USER_IPCAM_SET_STREAMTYPE_RESP = 0x60A,

    IOTYPE_USER_IPCAM_SET_FRAMERATE_REQ = 0x60B,
    IOTYPE_USER_IPCAM_SET_FRAMERATE_RESP = 0x60C,

    IOTYPE_USER_IPCAM_SET_STREAMRATE_REQ = 0x60D,
    IOTYPE_USER_IPCAM_SET_STREAMRATE_RESP = 0x60E,

    IOTYPE_USER_IPCAM_SET_STREAMSUPTYPE_REQ = 0x60F,
    IOTYPE_USER_IPCAM_SET_STREAMSUPTYPE_RESP = 0x610,

    IOTYPE_USER_IPCAM_SET_STREAMQUALITY_REQ = 0x611,
    IOTYPE_USER_IPCAM_SET_STREAMQUALITY_RESP = 0x612,

    IOTYPE_USER_IPCAM_SET_IFRAMEINTERVAL_REQ = 0x613,
    IOTYPE_USER_IPCAM_SET_IFRAMEINTERVAL_RESP = 0x614,

    IOTYPE_USER_IPCAM_SET_BRIGHTNESS_REQ = 0x615,
    IOTYPE_USER_IPCAM_SET_BRIGHTNESS_RESP = 0x616,

    IOTYPE_USER_IPCAM_SET_CONTRAST_REQ = 0x617,
    IOTYPE_USER_IPCAM_SET_CONTRAST_RESP = 0x618,

    IOTYPE_USER_IPCAM_SET_SATRUCTION_REQ = 0x619,
    IOTYPE_USER_IPCAM_SET_SATRUCTION_RESP = 0x61A,

    IOTYPE_USER_IPCAM_SET_SHARPNESS_REQ = 0x61B,
    IOTYPE_USER_IPCAM_SET_SHARPNESS_RESP = 0x61C,

    IOTYPE_USER_IPCAM_SET_HUE_REQ = 0x61D,
    IOTYPE_USER_IPCAM_SET_HUE_RESP = 0x61E,

    IOTYPE_USER_IPCAM_SET_FLIP_REQ = 0x61F,
    IOTYPE_USER_IPCAM_SET_FLIP_RESP = 0x620,

    IOTYPE_USER_IPCAM_SET_WIDE_DYNAMIC_REQ = 0x621,
    IOTYPE_USER_IPCAM_SET_WIDE_DYNAMIC_RESP = 0x622,

    IOTYPE_USER_IPCAM_SET_WHITE_BALANCE_REQ = 0x623,
    IOTYPE_USER_IPCAM_SET_WHITE_BALANCE_RESP = 0x624,

    IOTYPE_USER_IPCAM_SET_FLICKER_FREQ_REQ = 0x625,     // VAL: 50Hz/60Hz
    IOTYPE_USER_IPCAM_SET_FLICKER_FREQ_RESP = 0x626,

    IOTYPE_USER_IPCAM_SET_EXPORSE_REQ = 0x627,          // auto exporse
    IOTYPE_USER_IPCAM_SET_EXPORSE_RESP = 0x628,

    IOTYPE_USER_IPCAM_SET_DENOISE_REQ = 0x629,
    IOTYPE_USER_IPCAM_SET_DENOISE_RESP = 0x62A,

    IOTYPE_USER_IPCAM_SET_DAY_NIGHT_REQ = 0x62B,        // val: 0-day, 1-night, 2-auto, 3-schedule
    IOTYPE_USER_IPCAM_SET_DAY_NIGHT_RESP = 0x62C,

    IOTYPE_USER_IPCAM_SET_VIDEO_COVER_REQ = 0x62D,
    IOTYPE_USER_IPCAM_SET_VIDEO_COVER_RESP = 0x62E,

    IOTYPE_USER_IPCAM_SET_SHOW_DEV_NAME_REQ = 0x62F,
    IOTYPE_USER_IPCAM_SET_SHOW_DEV_NAME_RESP = 0x630,

    IOTYPE_USER_IPCAM_SET_SHOW_DATE_REQ = 0x631,
    IOTYPE_USER_IPCAM_SET_SHOW_DATE_RESP = 0x632,

    IOTYPE_USER_IPCAM_SET_TIME_FORMAT_REQ = 0x633,
    IOTYPE_USER_IPCAM_SET_TIME_FORMAT_RESP = 0x634,

    IOTYPE_USER_IPCAM_SET_DATE_FORMAT_REQ = 0x635,
    IOTYPE_USER_IPCAM_SET_DATE_FORMAT_RESP = 0x636,

    IOTYPE_USER_IPCAM_SET_SHOW_CHN_NAME_REQ = 0x637,
    IOTYPE_USER_IPCAM_SET_SHOW_CHN_NAME_RESP = 0x638,

    IOTYPE_USER_IPCAM_SET_CHANNEL_NAME_REQ = 0x639,
    IOTYPE_USER_IPCAM_SET_CHANNEL_NAME_RESP = 0x63A,

    IOTYPE_USER_IPCAM_SET_DEV_NAME_REQ = 0x63B,
    IOTYPE_USER_IPCAM_SET_DEV_NAME_RESP = 0x63C,

    IOTYPE_USER_IPCAM_SET_DEV_ID_REQ = 0x63D,
    IOTYPE_USER_IPCAM_SET_DEV_ID_RESP = 0x63E,

    IOTYPE_USER_IPCAM_SET_DATE_TIME_REQ = 0x63F,
    IOTYPE_USER_IPCAM_SET_DATE_TIME_RESP = 0x640,

    IOTYPE_USER_IPCAM_SET_RESTORE_DEV_REQ = 0x641,
    IOTYPE_USER_IPCAM_SET_RESTORE_DEV_RESP = 0x642,

    IOTYPE_USER_IPCAM_SET_RESTART_DEV_REQ = 0x643,
    IOTYPE_USER_IPCAM_SET_RESTART_DEV_RESP = 0x644,

    IOTYPE_USER_IPCAM_SET_FORMAT_DISK_REQ = 0x645,
    IOTYPE_USER_IPCAM_SET_FORMAT_DISK_RESP = 0x646,

    IOTYPE_USER_IPCAM_GET_DISK_STATUS_REQ = 0x647,
    IOTYPE_USER_IPCAM_GET_DISK_STATUS_RESP = 0x648,

    IOTYPE_USER_IPCAM_SET_UNMOUNT_DISK_REQ = 0x649, //unmount disk
    IOTYPE_USER_IPCAM_SET_UNMOUNT_DISK_RESP = 0x64A,

    IOTYPE_USER_IPCAM_SET_ALARM_MD_ENABLE_REQ = 0x64B,
    IOTYPE_USER_IPCAM_SET_ALARM_MD_ENABLE_RESP = 0x64C,

    IOTYPE_USER_IPCAM_SET_ALARM_MD_SENSIT_REQ = 0x64D,
    IOTYPE_USER_IPCAM_SET_ALARM_MD_SENSIT_RESP = 0x64E,

    IOTYPE_USER_IPCAM_SET_ALARM_COVER_ENABLE_REQ  = 0x64F,
    IOTYPE_USER_IPCAM_SET_ALARM_COVER_ENABLE_RESP = 0x650,

    IOTYPE_USER_IPCAM_SET_ALARM_COVER_SENSIT_REQ  = 0x651,
    IOTYPE_USER_IPCAM_SET_ALARM_COVER_SENSIT_RESP = 0x652,

    IOTYPE_USER_IPCAM_SET_DHCP_REQ  = 0x653,
    IOTYPE_USER_IPCAM_SET_DHCP_RESP = 0x654,
    
    IOTYPE_USER_IPCAM_PHOTO_REQ = 0x660,
    IOTYPE_USER_IPCAM_PHOTO_RESP = 0x661,

    IOTYPE_USER_SET_IPCAM_RECORD_REQ = 0x662,
    IOTYPE_USER_SET_IPCAM_RECORD_RESP = 0x663,

    IOTYPE_USER_IPCAM_TRIGGER_MD_ALARM    = 0x666,
    IOTYPE_USER_IPCAM_TRIGGER_COVER_ALARM = 0x667,

    IOTYPE_USER_IPCAM_SNAP_SHOT_REQ    = 0x668,
    IOTYPE_USER_IPCAM_SNAP_SHOT_RESP   = 0x669,
    /*allwinner v5 sdv support Cmd */
    IOTYPE_USER_SDV_SET_RECORD_RESOLUTION_REQ       = 0x670,
    IOTYPE_USER_SDV_SET_RECORD_RESOLUTION_RESP      = 0x671,

    IOTYPE_USER_SDV_SET_RECORD_LOOP_REQ  = 0x672,
    IOTYPE_USER_SDV_SET_RECORD_LOOP_RESP = 0x673,

    IOTYPE_USER_SDV_SET_RECORD_TIMELAPSE_REQ = 0x674,
    IOTYPE_USER_SDV_SET_RECORD_TIMELAPSE_RESP = 0x675,

    IOTYPE_USER_SDV_SET_RECORD_VOLUME_REQ = 0x676,
    IOTYPE_USER_SDV_SET_RECORD_VOLUME_RESP = 0x677,

    IOTYPE_USER_SDV_SET_RECORD_EIS_REQ = 0x678,
    IOTYPE_USER_SDV_SET_RECORD_EIS_RESP = 0x679,

    IOTYPE_USER_SDV_SET_RECORD_SLOWMOTION_REQ = 0x680,
    IOTYPE_USER_SDV_SET_RECORD_SLOWMOTION_RESP = 0x681,

    IOTYPE_USER_SDV_SET_PHOTO_RESOLUTION_REQ = 0x682,
    IOTYPE_USER_SDV_SET_PHOTO_RESOLUTION_RESP = 0x683,

    IOTYPE_USER_SDV_SET_PHOTO_TIMED_REQ = 0x684,
    IOTYPE_USER_SDV_SET_PHOTO_TIMED_RESP = 0x685,

    IOTYPE_USER_SDV_SET_PHOTO_AUTO_REQ = 0x686,
    IOTYPE_USER_SDV_SET_PHOTO_AUTO_RESP = 0x687,

    IOTYPE_USER_SDV_SET_PHOTO_DRAMASHOT_REQ = 0x688,
    IOTYPE_USER_SDV_SET_PHOTO_DRAMASHOT_RESP = 0x689,

    IOTYPE_USER_SDV_SET_CAMERA_EXPOSURE_REQ = 0x690,
    IOTYPE_USER_SDV_SET_CAMERA_EXPOSURE_RESP = 0x691,
    
    IOTYPE_USER_SDV_SET_CAMERA_WHITEBALANCE_REQ = 0x692,
    IOTYPE_USER_SDV_SET_CAMERA_WHITEBALANCE_RESP = 0x693,

    IOTYPE_USER_SDV_SET_CAMERA_LIGHTSOURCEFREQUENCY_REQ = 0x694,
    IOTYPE_USER_SDV_SET_CAMERA_LIGHTSOURCEFREQUENCY_RESP = 0x695,

    IOTYPE_USER_SDV_SET_CAMERA_IMAGEROTATION_REQ = 0x696,
    IOTYPE_USER_SDV_SET_CAMERA_IMAGEROTATION_RESP = 0x697,

    IOTYPE_USER_SDV_SET_TIME_WATERMARK_REQ = 0x698,
    IOTYPE_USER_SDV_SET_TIME_WATERMARK_RESP = 0x699,

    IOTYPE_USER_SDV_SET_DEVICE_FORMAT_REQ = 0x700,
    IOTYPE_USER_SDV_SET_DEVICE_FORMAT_RESP = 0x701,
    
    IOTYPE_USER_SDV_SET_CAMERA_AUTOSCREENSAVER_REQ = 0x702,
    IOTYPE_USER_SDV_SET_CAMERA_AUTOSCREENSAVER_RESP = 0x703,
    
    IOTYPE_USER_SDV_SET_CAMERA_TIMEDSHUTDOWN_REQ = 0x704,
    IOTYPE_USER_SDV_SET_CAMERA_TIMEDSHUTDOWN_RESP = 0x705,

    IOTYPE_USER_SDV_SET_DEVICE_LANGUAGE_REQ = 0x706,
    IOTYPE_USER_SDV_SET_DEVICE_LANGUAGE_RESP = 0x707,

    IOTYPE_USER_SDV_SET_DEVICE_DATETIME_REQ = 0x708,
    IOTYPE_USER_SDV_SET_DEVICE_DATETIME_RESP = 0x709,

    IOTYPE_USER_SDV_SET_DEVICE_RESETFACTORY_REQ = 0x710,
    IOTYPE_USER_SDV_SET_DEVICE_RESETFACTORY_RESP = 0x711,

    IOTYPE_USER_SDV_SET_CAMERA_DISTORTIONCALIBRATION_REQ = 0x712,
    IOTYPE_USER_SDV_SET_CAMERA_DISTORTIONCALIBRATION_RESP = 0x713,

    IOTYPE_USER_SDV_SET_CAMERA_LEDINDICATOR_REQ = 0x714,
    IOTYPE_USER_SDV_SET_CAMERA_LEDINDICATOR_RESP = 0x715,

    IOTYPE_USER_SDV_GET_DEVICE_CONFIG_REQ = 0x716,
    IOTYPE_USER_SDV_GET_DEVICE_CONFIG_RESP = 0x717,

    IOTYPE_USER_SDV_REMOTE_PRVIEW_REQ = 0x718,
    IOTYPE_USER_SDV_REMOTE_PRVIEW_RESP = 0x719,

    IOTYPE_USER_SDV_SAVE_ALL_CONFIG_REQ = 0x720,
    IOTYPE_USER_SDV_SAVE_ALL_CONFIG_RESP= 0x721,

    IOTYPE_USER_SDV_FILE_DELETE_REQ = 0x724,
    IOTYPE_USER_SDV_FILE_DELETE_RESP = 0x725,

    IOTYPE_USER_SDV_REMOTE_SLOW_RECORD_REQ = 0x726,
    IOTYPE_USER_SDV_REMOTE_SLOW_RECORD_RESP = 0x727,
 
    IOTYPE_USER_SDV_WIFI_SETTING_REQ = 0x728,
    IOTYPE_USER_SDV_WIFI_SETTING_RESP = 0x729,


    IOTYPE_USER_SDV_TFCARD_FULL_RESP = 0x72A,
 
    IOTYPE_USER_SDV_CONTINUE_TAKE_PHOTO_FINISHED_RESP = 0x730,
/***********************allWinner IPC support Cmd END *************************/
...
/******************************Allwinner Expand Start*******************************/
/*
IOTYPE_USER_IPCAM_SETSOFTAP_REQ = 0x0336,
IOTYPE_USER_IPCAM_GETSOFTAP_RESP = 0x0339,
** @struct SMsgAVIoctrlSetSoftApReq
** @struct SMsgAVIoctrlGetSoftApResp
*/
typedef struct {
    unsigned char ssid[32];            //softap ssid
    unsigned char password[32];        //if need, softap password
    unsigned int mode;
    unsigned int enctype;
    unsigned int frequency;           //0-2.4GHz, 1-5GHz
    unsigned char reserved[4];
} SMsgAVIoctrlSetSoftApReq, SMsgAVIoctrlGetSoftApResp;

/*
IOTYPE_USER_IPCAM_SETSOFTAP_RESP = 0x0337,
IOTYPE_USER_IPCAM_SET_IPADDR_RESP = 0x601,
** @struct SMsgAVIoctrlSetSoftApResp
** @struct SMsgAVIoctrlSetIPAddrResp
*/
typedef struct {
    int result;
    unsigned char reserved[4];
} SMsgAVIoctrlSetSoftApResp,SMsgAVIoctrlSetIPAddrResp;

/*
IOTYPE_USER_IPCAM_GETSOFTAP_REQ = 0x0338,
IOTYPE_USER_IPCAM_GET_IPADDR_REQ = 0x602,
** @struct SMsgAVIoctrlGetSoftApReq
** @struct SMsgAVIoctrlGetIPAddrReq
*/
typedef struct {
    unsigned char reserved[4];
} SMsgAVIoctrlGetSoftApReq,SMsgAVIoctrlGetIPAddrReq;


/*
 IOTYPE_USER_IPCAM_SET_IPADDR_REQ = 0x600
 IOTYPE_USER_IPCAM_GET_IPADDR_RESP = 0x603,
**@struct SMsgAVIoctrlSetIPAddrEeq
**@struct SMsgAVIoctrlGetAPAddrResp
*/
typedef struct {
    char macaddr[32];
    char ipaddr[32];
...
}SMsgAVIoctrlSetIPAddrReq,SMsgAVIoctrlGetAPAddrResp;
...
/**
 IOTYPE_USER_IPCAM_GET_DEVICE_CONFIG_REQ = 0x604,
 IOTYPE_USER_IPCAM_GET_DEVICE_CONFIG_RESP = 0x605,
 **@struct  SMsgAVIoctrDevConfigResp
 */
typedef struct {
    ...
    unsigned int  streamsuptype;
    unsigned int  streamquality;
    unsigned int  Iframeinterval;
    
    /* overlay configs */
    unsigned int time_osd_enable;   // val: 0-disable, !0-enable.
    unsigned int time_format;       // val: 0-12hour, 1-24hour
    unsigned int date_format;       // val: 0-yyyy-mm-dd, 1-mm-dd-yyyy, 2-dd-mm-yyyy
    unsigned int video_cover;       // val:
    unsigned int show_chn_enable;   // val: 0-disable, !0-enable.
    char chn_name[128];             // val: channel name
    unsigned int show_dev_enable;   // val: 0-disable, !0-enable.
    char dev_name[128];             // val: device name

    /* Image configs */
    int brightness;        // val: 0~100
    int contrast;          // val: 0~100
    int saturation;        // val: 0~100
    int sharpness;         // val: 0~100
    int hue;               // val: 0~100
    int flip;              // val: 0-normal, 1-flip, 2-mirror, 3-flip+mirror.
    int white_balance;     // val: 0-disable, 1-auto, 2-level_1, 3-level_2, 4-level_3, 5-level-4
    int exposure_type;     // val: 0-auto, 1-manual
    int exposure_time;     // val: 1~10000
    int wide_dynamic;      // val: 0-disable, 1-level_1, 2-level_2, 3-level_3, 4-level_4, 5-level_5
    int flicker_freq;      // val: 0-auto, 1-50Hz, 2-60Hz
    int denoise;           // val: 0-disable, 1-level_1, 2-level_2, 3-level_3, 4-level_4, 5-level_5
    int day_night_mode;    // val: 0-day, 1-night, 2-auto, 3-schedule
    ...
    /* storage */
    unsigned int capacity;          // val: 单位MB
    unsigned int free_space;        // val: 单位MB
    unsigned int disk_status;       // val:0-正常，1-未格式化，2-错误，3-文件系统不匹配，4-休眠, 5-无磁盘, 6-正在格式化

    /* alarm config */
    unsigned int alarm_md_enable;   // val: 0-disable, !0-enable
    unsigned int alarm_md_sensitive;// val: 1~100
    unsigned int alarm_cover_enable;// val: 0-disable, !0-enable
    unsigned int alarm_cover_sensitive; // val: 1~100

    /* network config */
    unsigned int net_type;          // val: 0-use ethernet, 1-use wifi station, 2-use wifi ap
    unsigned int dhcp;              // val: 0-disable DHCP, 1-enable DHCP

    unsigned char reserved[8];
}SMsgAVIoctrDevConfigResp;

/*@struct sdv menu config*/
 typedef struct AVParam{
     int   current;
     int   count;
 }AVIOParam;
  typedef struct AVString1{
     char string1[128];
 }AVIOString1;
 typedef struct AVString2{
     char string1[128];
     char string2[128];
 }AVIOString2;
 typedef struct AVString3{
     char string1[128];
     char string2[128];
     char string3[128];
 }AVIOString3;  
 typedef struct AVString4{
     char string1[128];
     char string2[128];
     char string3[128]; 
     char string4[128];
 ...
 typedef struct AVMenuConfig_{
    ...
    /*****record******/
    AVIOParam record_resolution;
    AVIOParam record_rear_resolution;
    AVIOParam record_sound;
    AVIOParam record_screen_brightness;
    AVIOParam record_screen_disturb_mode;
    AVIOParam record_voice_take_photo;
    AVIOParam record_switch_wifi;
    AVIOParam record_4g_network_switch;
    AVIOParam record_volume_selection;
    AVIOParam record_power_on_sound;
    AVIOParam record_key_sound;
    AVIOParam record_drivering_report;
    AVIOParam record_adas;
    AVIOParam record_adas_forward_collision_waring;
    AVIOParam record_adas_lane_shift_reminding;
    AVIOParam record_watchdog;
    AVIOParam record_probeprompt;
    AVIOParam record_speedprompt;
    AVIOParam record_timewatermark;
    AVIOParam record_emerrecord;
    AVIOParam record_emerrecordsen;
    AVIOParam record_parkingwarnlamp_switch;
    AVIOParam record_parkingmonitor_switch;
    AVIOParam record_parkingabnormalmonitory_switch;
    AVIOParam record_parkingloopabnormalnotice_switch;
    AVIOParam record_parkingloop_switch;
    AVIOParam record_parkingloop_resolution;
    AVIOParam record_loop; 
    AVIOParam record_standby_clock;
    AVIOParam record_timelapse; 
    AVIOParam record_slowmotion; 
    
     /*****photo******/
    AVIOParam photo_resolution;
    AVIOParam photo_timed;
    AVIOParam photo_auto;
    AVIOParam photo_dramashot; 
    
     /*****camera******/
    AVIOParam camera_exposure;
    AVIOParam camera_whitebalance;
    AVIOParam camera_lightfreq;
    AVIOParam camera_autoscreensaver;
    AVIOParam camera_timedshutdown; 
         
    AVIOString2 camera_wifiinfo; 
    AVIOString1 device_sysversion;
    AVIOString1 device_update;
    AVIOString1 device_systemTime;
	AVIOString1 device_carid;
    /*****device******/
    AVIOParam device_language;
    AVIOParam device_datatime;
    AVIOParam device_voicestatus;
    AVIOString4 device_deviceinfo;

    AVIOParam record_encodingtype;

}SMsgAVIoctrSDVDevConfigResp;

/**
 @struct SMsgAVIoctrlSetSettingValue
 */
typedef struct {
    unsigned int  setvalue;
}SMsgAVIoctrlSetSettingValue;

typedef struct{
    unsigned int curSel[4];
}SMsgAVIoctrlVideoCoverReq;

/*
IOTYPE_USER_IPCAM_AW_SET_XXXX_REQ
** @struct SMsgAVIoctrlAwSetChannelREQ
*/
typedef struct {
    unsigned int channel;    // Camera Index
    unsigned int value;
    unsigned char reserved[4];
} SMsgAVIoctrlAwSetChannelREQ, SMsgAVIoctrlAwSetChannelRESP;

/*
IOTYPE_USER_IPCAM_AW_SET_XXXX_REQ
** @struct SMsgAVIoctrlAwSetCharREQ
*/
typedef struct {
    unsigned int channel;    // Camera Index
    char valuechar[256];
} SMsgAVIoctrlAwSetCharReq, SMsgAVIoctrlAwSetCharResp;

/*
IOTYPE_USER_IPCAM_SET_EXPORSE_REQ
** @struct SMsgAVIoctrlSetExpoTimeReq
*/
typedef struct {
    unsigned int channel; // Camera Index
    unsigned int  isauto;
    unsigned int  time;
    unsigned char reserved[4];
} SMsgAVIoctrlSetExpoTimeReq;

/*
IOTYPE_USER_IPCAM_GET_DISK_STATUS_RESP
** @struct SMsgAVIoctrlGetDiskInfoResp
*/
typedef struct {
    unsigned int capacity;          // val: 单位MB
    unsigned int free_space;        // val: 单位MB
    unsigned int disk_status;       // val:0-正常，1-未格式化，2-错误，3-文件系统不匹配，4-休眠, 5-无磁盘, 6-正在格式化
    unsigned char reserved[4];
} SMsgAVIoctrlGetDiskInfoResp;

/*
IOTYPE_USER_IPCAM_SET_DATE_TIME_REQ
** @struct SMsgAVIoctrlSetTimeReq
*/
typedef struct {
    unsigned int year;
    unsigned int month;
...
typedef struct {
    ...
    // because avSendIOCtrl() send package up to 1024 bytes one time,
    // you may want split search results to serveral package to send.
...
{
    unsigned int    channel;           //Camera Index
    //extern out index: bit0->io0 bit1->io1 ... bit7->io7;=1: get this io value or not get
    unsigned char   externIoOutIndex;
    //extern in index: bit0->io0 bit1->io1 ... bit7->io7; =1: get this io value or not get
    unsigned char   externIoInIndex;
    char reserved[2];
...
/* IOTYPE_USER_IPCAM_GETAUDIOOUTFORMAT_REQ            = 0x032A, //used to speak.
 * but once camera is connected by App, send this at once.
 */
typedef struct {
    unsigned int channel;        // camera index
    char reserved[4];
...
typedef struct aw_sdv_handle_file
{
    char filename[256];
}aw_sdv_handle_file;
#endif
