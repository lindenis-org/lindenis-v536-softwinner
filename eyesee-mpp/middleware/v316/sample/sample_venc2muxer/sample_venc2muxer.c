...
static int getFileNameByCurTime(char *pNameBuf)
{
    ...
    strncpy(pNameBuf, pVenc2MuxerData->mConfigPara.dstVideoFile, len-1);
...
static int configVencChnAttr(SAMPLE_VENC2MUXER_S *pVenc2MuxerData)
{
    ...
    if (PT_H264 == pVenc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        case 1:
            ...
            pVenc2MuxerData->mVencChnAttr.RcAttr.mAttrH264Vbr.mMinQp = 10;
            pVenc2MuxerData->mVencChnAttr.RcAttr.mAttrH264Vbr.mMaxQp = 40;
            break;
        case 2:
    ...
    else if (PT_H265 == pVenc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        case 1:
            ...
            pVenc2MuxerData->mVencChnAttr.RcAttr.mAttrH265Vbr.mMinQp = 10;
            pVenc2MuxerData->mVencChnAttr.RcAttr.mAttrH265Vbr.mMaxQp = 40;
            break;
        case 2:
