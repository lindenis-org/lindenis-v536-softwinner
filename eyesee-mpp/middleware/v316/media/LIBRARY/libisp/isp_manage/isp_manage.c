...
HW_S32 __isp_ctx_update_ae_cfg(struct isp_lib_context *isp_gen)
{
	...
	isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_favor = isp_gen->isp_ini_cfg.isp_3a_settings.ae_gain_favor;
	memcpy(&isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_range[0], &isp_gen->isp_ini_cfg.isp_3a_settings.ae_gain_range[0], 4*sizeof(int));
	...
	memcpy(&isp_gen->ae_entity_ctx.ae_param->ae_ini.wdr_cfg[0], &isp_gen->isp_ini_cfg.isp_3a_settings.wdr_cfg[0], 3*sizeof(int));
	...
	//get gain range
	isp_gen->tune.gains.gain_favor = isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_favor;
	isp_gen->tune.gains.ana_gain_min = isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_range[0];
	isp_gen->tune.gains.ana_gain_max = isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_range[1];
	isp_gen->tune.gains.dig_gain_min = isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_range[2];
	isp_gen->tune.gains.dig_gain_max = isp_gen->ae_entity_ctx.ae_param->ae_ini.ae_gain_range[3];
