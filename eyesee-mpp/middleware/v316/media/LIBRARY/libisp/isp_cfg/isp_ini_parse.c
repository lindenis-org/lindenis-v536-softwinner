...
#ifdef SENSOR_IMX258
#include "SENSOR_H/imx258/imx258_4k_v163.h"
#endif
...
#include "SENSOR_H/imx335/imx335_25fps_ini_cdr.h"
//#endif
...
#ifdef SENSOR_IMX258
	{"imx258_mipi",  "imx258_4k_v163", 4096, 2160, 20, 0, 0, &imx258_isp_cfg},
	{"imx258_mipi",  "imx258_4k_v163", 4096, 2160, 30, 0, 0, &imx258_isp_cfg},
#endif

#ifdef SENSOR_IMX278
	{"imx278_mipi",  "imx278_full_v5", 4208, 3120, 20, 0, 0, &imx278_full_v5},
	{"imx278_mipi",  "imx278_4k_v5", 4208, 2368, 30, 0, 0, &imx278_4k_v5},
	{"imx278_mipi",  "imx278_60fps_v5", 2096, 1184, 60, 0, 0, &imx278_60fps_v5},
	{"imx278_mipi",  "imx278_120fps_v5", 1280, 720, 120, 0, 0, &imx278_120fps_v5},
#endif

#ifdef SENSOR_IMX386
	{"imx386_mipi",  "imx386_full_v200", 3584, 2688, 20, 0, 0,    &imx386_full_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_4k_v200", 4032, 2256, 30, 0, 0,      &imx386_4k_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_4k_v200", 3840, 2160, 25, 0, 0,      &imx386_4k_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_4k_v200", 3840, 2160, 30, 0, 0,      &imx386_4k_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_1800_v200", 3200, 1800, 60, 0, 0,    &imx386_1800p_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_60fps_v200", 1920, 1080, 60, 0, 0,   &imx386_60fps_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_60fps_v200", 2016, 1128, 60, 0, 0,   &imx386_60fps_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_120fps_v200", 1920, 1080, 120, 0, 0, &imx386_120fps_mipi_isp_cfg},
	{"imx386_mipi",  "imx386_240fps_v200", 1280, 720, 240, 0, 0,  &imx386_240fps_mipi_isp_cfg},
#endif

//#ifdef SENSOR_IMX335
	//{"imx335_mipi", "imx335_30fps_ini_cdr", 2592, 1944, 30, 0, 0, &imx335_30fps_ini_cdr},
    {"imx335_mipi", "imx335_25fps_ini_cdr", 2592, 1944, 30, 0, 0, &imx335_25fps_ini_cdr},
//#endif
};
			...
			int w, int h, int fps, int wdr, int ir, int sync_mode, int isp_id)
{
	...
	if (i == array_size(cfg_arr)) {
		...
		if (i == array_size(cfg_arr)) {
			ISP_WARN("cannot find %s_%d_%d_%d_%d isp config, use default!!!\n", sensor_name, w, h, fps, wdr);
			return -1;
		}
	}
