...
VENC_H265PROFILETYPE map_VENC_ATTR_H265_S_Profile_to_VENC_H264PROFILETYPE(unsigned int nProfile)
{
...
static int CedarvEncInit(VIDEOENCDATATYPE *pVideoEncData)
{
   ...
   // unsigned int nDstFrameRate = 0;
    ...
    else if(PT_H265 == pVideoEncData->mEncChnAttr.VeAttr.Type)
    {
        ...
        h265Param.sProfileLevel.nProfile = map_VENC_ATTR_H265_S_Profile_to_VENC_H264PROFILETYPE(pVideoEncData->mEncChnAttr.VeAttr.AttrH265e.mProfile);
...
static int CedarvVideoEncInit(VIDEOENCDATATYPE *pVideoEncData)
{
    ...
    if(pVideoEncData->pCedarV)
    {
        ...
        else if(PT_H264 == pVideoEncData->mEncChnAttr.VeAttr.Type)
        {
            ...
            switch(pVideoEncData->mEncChnAttr.RcAttr.mRcMode)
            {
                ...
                case VENC_RC_MODE_H264VBR:
                {
                    ...
                    h264Param.sRcParam.sVbrParam.uRatioChangeQp = pVideoEncData->mEncChnAttr.RcAttr.mAttrH264Vbr.mRatioChangeQp;
            ...
            //config the RefParam
            //if(0 == pVideoEncData->mRefParam.nBase || 0 == pVideoEncData->mRefParam.nEnhance)
            //{
            //    pVideoEncData->mRefParam.bAdvancedRefEn = 0;
            //    pVideoEncData->mRefParam.nBase = 0;
            //    pVideoEncData->mRefParam.nEnhance = 0;
            //    pVideoEncData->mRefParam.bRefBaseEn = 0;
            //    //aolge("fatal error! the RefParam is not work!");
            //}
            //else
            //{
        ...
        else if(PT_H265 == pVideoEncData->mEncChnAttr.VeAttr.Type)
        {
            ...
            memset(&h265Param, 0, sizeof(VencH265Param));
            h265Param.sProfileLevel.nProfile = map_VENC_ATTR_H265_S_Profile_to_VENC_H264PROFILETYPE(pVideoEncData->mEncChnAttr.VeAttr.AttrH265e.mProfile);
            h265Param.sProfileLevel.nLevel = map_H265_LEVEL_E_to_VENC_H265LEVELTYPE(pVideoEncData->mEncChnAttr.VeAttr.AttrH264e.mLevel);//VENC_H265Level62;
            //h265Param.bLongTermRef = (int)pVideoEncData->mEncChnAttr.VeAttr.AttrH265e.mbLongTermRef;
            ...
            switch(pVideoEncData->mEncChnAttr.RcAttr.mRcMode)
            {
                ...
                case VENC_RC_MODE_H265VBR:
                {
                    ...
                    h265Param.sRcParam.sVbrParam.uRatioChangeQp = pVideoEncData->mEncChnAttr.RcAttr.mAttrH265Vbr.mRatioChangeQp;
                            ...
                            || MM_PIXEL_FORMAT_YUV_AW_LBC_1_0X == pVideoEncData->mEncChnAttr.VeAttr.PixelFormat)
                        {
                            ...
                            switch(pVideoEncData->mEncChnAttr.VeAttr.PixelFormat)
                            {
                                case MM_PIXEL_FORMAT_YUV_AW_AFBC:
                                    snprintf(DbgStoreFilePath, 256, "/mnt/extsd/pic[%d][id%d][%lldus].afbc", pVideoEncData->mDbgEncodeCnt, pFrameNode->VFrame.mId, pFrameNode->VFrame.VFrame.mpts);
                                    break;
                                case MM_PIXEL_FORMAT_YUV_AW_LBC_2_0X:
                                    snprintf(DbgStoreFilePath, 256, "/mnt/extsd/pic[%d][id%d][%lldus].lbc20x", pVideoEncData->mDbgEncodeCnt, pFrameNode->VFrame.mId, pFrameNode->VFrame.VFrame.mpts);
                                    break;
                                case MM_PIXEL_FORMAT_YUV_AW_LBC_2_5X:
                                    snprintf(DbgStoreFilePath, 256, "/mnt/extsd/pic[%d][id%d][%lldus].lbc25x", pVideoEncData->mDbgEncodeCnt, pFrameNode->VFrame.mId, pFrameNode->VFrame.VFrame.mpts);
                                    break;
                                case MM_PIXEL_FORMAT_YUV_AW_LBC_1_0X:
