# Makefile for eyesee-mpp/middleware/media/component
CUR_PATH := .
PACKAGE_TOP := ../..
...
LOCAL_TARGET_DYNAMIC := libmpp_component
endif
LOCAL_TARGET_STATIC :=
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-component done
	@echo ===================================
