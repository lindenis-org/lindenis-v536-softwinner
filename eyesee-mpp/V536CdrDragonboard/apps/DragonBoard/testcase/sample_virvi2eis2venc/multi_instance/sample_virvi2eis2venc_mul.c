...
int main(int argc, char *argv[])
{
    ...
    pVippAttr[0]->nbufs = ViEisVencCfg.stUsrCfg.iInputBufNum;
    pVippAttr[0]->nplanes = 0;
    ...
    pVippAttr[1]->format.width  = ViEisVencCfg.stUsrCfg.iCapVideoWidth;
    pVippAttr[1]->format.height = ViEisVencCfg.stUsrCfg.iCapVideoHeight;
    pVippAttr[1]->fps = ViEisVencCfg.stUsrCfg.iVideoFps;
    /* Update configuration anyway, do not use current configuration */
    pVippAttr[1]->use_current_win = 1;
    pVippAttr[1]->nbufs = ViEisVencCfg.stUsrCfg.iInputBufNum;
    pVippAttr[1]->nplanes = 0;
    ...
    if (ViEisVencCfg.EisCfg[0].stEisAttr.eOperationMode == EIS_OPR_1080P60) {
        ViEisVencCfg.EisCfg[0].stEisAttr.iVideoOutWidth  = 1344;
        ViEisVencCfg.EisCfg[0].stEisAttr.iVideoOutHeight = 768;
    }
    ViEisVencCfg.EisCfg[0].stEisAttr.iVideoFps = pVippAttr[0]->fps;
    ...
    for (i = 0; (i < ViEisVencCfg.stUsrCfg.iRebootCnt)&&!g_bBreakProgress; i++) {
        ...
        */
        ...
        AW_MPI_VENC_GetH264SpsPpsInfo(iVeChn, &stVencHeader);
