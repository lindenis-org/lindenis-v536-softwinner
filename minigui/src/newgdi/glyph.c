...
#else /* DRAW_SCANLINE */
	//fprintf(fp3,"@@@@6666666666666666666@@@@@\n");
...
*/
    ...
    glyph_bmptype = devfont->font_ops->get_glyph_type (logfont, devfont) 
            & DEVFONTGLYPHTYPE_MASK_BMPTYPE;
	//fprintf(fp3,"this advance is %d,glyph_bmptype is %d\n",advance,glyph_bmptype);
    ...
    fg_gal_rc.w = bbox.w + italic; 
    fg_gal_rc.h = bbox.h;
	//fprintf(fp3,"this fg_gal_rc.x = %d,fg_gal_rc.y =  %d\n", fg_gal_rc.x, fg_gal_rc.y);
