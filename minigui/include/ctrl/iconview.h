...
typedef struct _IVITEMINFO
{
	...
	/**
     * The bitmap function icon of the item
     */
    PBITMAP icon_filetype;
	PBITMAP icon_filelock[2];
	PBITMAP icon_filesel[2];

	/**
     * The bitmap path of the item
     */
    const char *bmppath;
...
#define IVM_SETITEMBMP			  0xF437
#define IVM_SETITEMICON			  0xF438
#define IVM_SETITEM_LOCK		  0xF439
#define IVM_SETITEM_SELECT		  0xF43A

#define IVM_SETITEM_SELECTALL     0xF43B
#define IVM_GETITEM_LOCK		  0xF43C
#define IVM_GETITEM_SELECT		  0xF43D
